...
//tealium universal tag - utag.sender.googleadwords ut4.0.201502092028, Copyright 2015 Tealium.com Inc. All Rights Reserved.
try{
(function(id,loader,u){
  ...
  u.map={"part_id_meta":"google_custom_params.ecomm_prodid","gr_page_type":"google_custom_params.ecomm_pagetype","supplier_id":"google_custom_params.ecomm_supplier"};
  u.extend=[function(a,b){
if (b["meta.wt.z_supplier_id"]){
b.supplier_id = b["meta.wt.z_supplier_id"];
    }


if (b["meta.wt.z_part_id"]){
b.part_id_meta = b["meta.wt.z_part_id"];
    }

},
function(a,b){ try{ if(1){b['gr_page_type']='default'} } catch(e){ utag.DB(e) }  },
function(a,b){ try{ if(b['dom.pathname']=='/'){b['gr_page_type']='home'} } catch(e){ utag.DB(e) }  },
function(a,b){ try{ if((b['meta.wt.cg_n'].toString().toLowerCase().indexOf('Part Search'.toLowerCase())>-1&&b['meta.wt.cg_s'].toString().toLowerCase().indexOf('Part Detail'.toLowerCase())>-1)){b['gr_page_type']='product_detail'} } catch(e){ utag.DB(e) }  },
function(a,b){ try{ if(b['dom.pathname'].toString().toLowerCase().indexOf('AddPart.aspx'.toLowerCase())>-1){b['gr_page_type']='cart'} } catch(e){ utag.DB(e) }  },
function(a,b){ try{ if(b['page_title']=='Order Confirmation'){b['gr_page_type']='confirmation'} } catch(e){ utag.DB(e) }  }];
